...
Mouse drag copies within one pane · drag the divider to resize panes · `=` center divider · `j/k` scroll · `ctrl-d/u` half-page · `n/p` next/prev file · `g/G` top/bottom · `q` quit
